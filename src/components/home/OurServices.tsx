            ...
            return (
              ...
              >
                <div>
                  ...
                  <h3 className="text-lg font-semibold text-white tracking-tight mb-2 group-hover:text-[#D4AF37] transition-colors duration-200">
                    {service.title}
                  </h3>
                ...
                <div className="absolute bottom-0 right-0 w-0 h-[2px] bg-[#D4AF37]/40 group-hover:w-16 transition-all duration-500 rounded-br-2xl" />
              </div>
            );
          })}
        </div>
