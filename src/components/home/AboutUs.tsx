...
function AboutUs() {
  return (
    <div className="bg-[#F8FAFC] text-slate-800 selection:bg-[#D4AF37]/10 selection:text-[#D4AF37]">
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-12 pb-8">
        <div className="text-center max-w-3xl mx-auto flex flex-col items-center">
          ...
          <p className="text-lg sm:text-xl font-normal text-slate-500 tracking-wide max-w-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative">
            <div className="grid grid-cols-12 gap-4 items-stretch relative z-10">
              <div className="col-span-8 rounded-2xl overflow-hidden shadow-xl shadow-slate-200/50 border border-slate-200/80 h-80 transition-transform duration-500 hover:scale-[1.02]">
                <img 
              ...
              <div className="col-span-4 flex flex-col gap-4">
                <div className="rounded-2xl overflow-hidden shadow-md border border-slate-200/80 h-44 transition-transform duration-500 hover:scale-[1.03]">
                  <img 
                ...
                <div className="rounded-2xl overflow-hidden shadow-md border border-slate-200/80 h-32 transition-transform duration-500 hover:scale-[1.03]">
                  <img 
          ...
          <div className="lg:col-span-6 flex flex-col gap-8">
            ...
            <div className="space-y-6">
              <div className="flex flex-col gap-1.5 border-l-2 border-[#D4AF37]/40 pl-5 relative group">
                ...
                <h4 className="text-base font-semibold text-[#0F172A] group-hover:text-[#D4AF37] transition-colors duration-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {CORE_PILLARS.map((pillar, index) => {
            ...
            return (
              <div 
                key={index}
                className="group bg-white rounded-2xl border border-slate-200/80 p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-200/40 hover:border-[#D4AF37]/40 flex flex-col justify-between"
              >
                <div>
                  <div className="h-12 w-12 rounded-xl bg-[#F8FAFC] border border-slate-200/60 flex items-center justify-center text-[#D4AF37] mb-6 group-hover:bg-[#D4AF37] group-hover:text-[#0F172A] transition-all duration-300 group-hover:scale-105">
                    <Icon className="h-5 w-5" />
                  </div>
                  <h3 className="text-xl font-semibold text-[#0F172A] tracking-tight mb-3">
                    {pillar.title}
                  </h3>
                  <p className="text-slate-500 text-sm font-light leading-relaxed">
                    {pillar.description}
