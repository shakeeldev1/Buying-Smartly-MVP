      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-17 items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <a href="/auth/signin" className="text-sm font-medium text-slate-600 hover:text-[#D4AF37] transition-colors duration-200">
              Sign In
            </a>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-b border-slate-200/50">
          <div className="space-y-1 px-2 pb-4 pt-2 sm:px-3">
            ...
            <a href="/services" className="block rounded-lg px-3 py-2.5 text-base font-medium text-slate-700 hover:bg-slate-100 hover:text-[#D4AF37]">Services</a>
