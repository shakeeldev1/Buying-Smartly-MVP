...
function Footer() {
  return (
    <footer className="border-t border-zinc-800 bg-black text-zinc-400 font-sans">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-6 xl:col-span-1">
            ...
            <p className="text-sm max-w-md text-zinc-400 leading-relaxed">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0 sm:grid-cols-3">
            ...
            {/* Core Pages Column */}
            <div>
              <h3 className="text-xs font-semibold uppercase tracking-wider text-zinc-200">Company</h3>
              <ul role="list" className="mt-4 space-y-2 text-sm">
                <li><a href="/" className="hover:text-white transition-colors">Home Base</a></li>
                <li><a href="/about" className="hover:text-white transition-colors">Our Story (About)</a></li>
                <li><a href="/services" className="hover:text-white transition-colors">Core Services</a></li>
                <li><a href="/contact" className="hover:text-white transition-colors">Get In Touch (Contact)</a></li>
              </ul>
            </div>

            {/* Ecosystem Verticals Column */}
            <div>
              <h3 className="text-xs font-semibold uppercase tracking-wider text-zinc-200">Ecosystem Hubs</h3>
              <ul role="list" className="mt-4 space-y-2 text-sm">
                <li><a href="#" className="hover:text-white transition-colors">Shopping & Sourcing</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Travel Experiences</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Logistics Networks</a></li>
            ...
            <div className="col-span-2 sm:col-span-1">
              <h3 className="text-xs font-semibold uppercase tracking-wider text-zinc-200">Partnerships</h3>
              <ul role="list" className="mt-4 space-y-2 text-sm">
                <li>
                ...
                <li><a href="#" className="hover:text-white transition-colors">Listing Parameters</a></li>
              </ul>
            </div>
          </div>
