...
import {
  ...
  Image as ImageIcon, DollarSign, List, Info, LayoutTemplate, Briefcase, Zap
} from 'lucide-react';
...
const STEPS = [
  ...
  { n: 4, id: 'review', title: 'Review & Publish', desc: 'Final check before going live', icon: Zap },
];
...
const CreateService: React.FC = () => {
  ...
  const { register, handleSubmit, control, watch, setValue, trigger, formState: { errors } } = useForm<ServiceFormValues>({
    defaultValues: {
        ...
        <div className="bg-white rounded-2xl shadow-2xl shadow-black/20 w-full max-w-[960px] h-full max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-300 border border-[#E5E7EB] pointer-events-auto">
          ...
          <div className="flex items-center justify-between px-8 py-5 border-b border-[#F3F4F6] bg-white shrink-0">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-[18px] font-bold text-[#111827] tracking-tight">Create New Service</h2>
                <p className="text-[13px] text-[#6B7280] mt-0.5">Define your offering and start receiving requests.</p>
              </div>
            </div>
              ...
              <div className="mt-12 p-4 bg-[#F3F4F6] rounded-xl border border-[#E5E7EB]">
                <div className="flex items-start gap-2.5">
                  ...
                  <p className="text-[11px] text-[#4B5563] leading-relaxed">
                    A well-defined service catalog increases conversion rates by 40%. Make sure your features and requirements are crystal clear.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="max-w-[520px] mx-auto pb-12">
                ...
                {step === 1 && (
                  <div className="space-y-8 animate-in slide-in-from-right-4 fade-in duration-300">
                    <div>
                      ...
                      <p className="text-[13px] text-[#6B7280]">Provide the basic details that clients will see first.</p>
                    </div>
                ...
                {step === 2 && (
                  <div className="space-y-8 animate-in slide-in-from-right-4 fade-in duration-300">
                    <div>
                      ...
                      <p className="text-[13px] text-[#6B7280]">Set expectations around cost and what is included.</p>
                    </div>
                ...
                {step === 3 && (
                  <div className="space-y-8 animate-in slide-in-from-right-4 fade-in duration-300">
                    <div>
                      ...
                      <p className="text-[13px] text-[#6B7280]">Make it look great and tell clients what you need.</p>
                    </div>
                ...
                {step === 4 && (
                  <div className="space-y-6 animate-in slide-in-from-right-4 fade-in duration-300">
                    <div>
                      <h3 className="text-[20px] font-bold text-[#111827] mb-1">Review & Publish</h3>
                      <p className="text-[13px] text-[#6B7280]">Here's how your service will appear to clients.</p>
                    </div>
                    ...
                    <div className="p-4 bg-[#FAFAFA] border border-[#E5E7EB] rounded-xl flex items-start gap-3 mt-4">
                      ...
                      <div>
                        <p className="text-[13px] font-bold text-[#111827]">Ready to go live</p>
                        <p className="text-[12px] text-[#6B7280] mt-0.5 leading-relaxed">
                          By publishing, you agree to BuySmartly's provider guidelines and terms of service.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="border-t border-[#E5E7EB] px-6 sm:px-8 py-5 bg-white flex items-center justify-between shrink-0">
            ...
            {step < 4 ? (
              ...
              >
                <CheckCircle className="h-4 w-4 group-hover:scale-110 transition-transform" /> Publish Service
              </button>
            )}
          </div>
